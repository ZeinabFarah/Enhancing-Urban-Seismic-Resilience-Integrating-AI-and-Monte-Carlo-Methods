...
class EarthquakeGenerator:
    def __init__(self, setup, magnitude_frequency_distribution, ground_motion_equation_model, use_reference_velocity, reference_velocity):
        """
        ...
        self.use_reference_velocity = use_reference_velocity
    ...
    def generate_scenarios(self, num_scenarios):
        ...
        Magnitudes = np.linspace(self.setup.m_min_min, self.setup.m_max_max, num_scenarios)
        ...
        magnitudes = np.random.choice(Magnitudes, size=num_scenarios, p=prob_of_magnitudes)
    ...
    def calculate_ground_motion_parameters(self, ground_motion_type, magnitudes, sources):
        ...
        for i, magnitude in enumerate(magnitudes):
          ...
          for j, site_id in enumerate(self.setup.site_id):
            ...
            if self.use_reference_velocity:
                resp_ref = np.exp(model._calc_ln_resp(self.reference_velocity, np.nan))
    ...
    def generate_norm_intra_event_residuals(self, num_scenarios, ground_motion_type, period=None):
        """
    ...
    def generate_earthquake_objects(self, num_scenarios):
        ...
        for ground_motion_type in ['PGA', 'PGV']:
            ...
            norm_intra_event_residual = self.generate_norm_intra_event_residuals(num_scenarios, ground_motion_type)
            ...
            for i, magnitude in enumerate(magnitudes):
                ...
                for j, site_id in enumerate(self.setup.site_id):
                    ...
                    if key not in combined_data:
                        combined_data[key] = {}
                    combined_data[key][ground_motion_type] = im_value
